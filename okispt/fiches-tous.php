...
$req3="SELECT * FROM `etudiants` where code_entreprise2='$codes'";
...
$req="SELECT * FROM `etudiants` where code_entreprise2='$codes'";
...
$req="SELECT * FROM `etudiants` where code_entreprise2='àààoi_iiiuhj___çàààààkkkjbh&'";
$rs=mysql_query($req) or (die(mysql_error()));
