...
$req3="SELECT * FROM `etudiants` where code_entreprise='$codes'";
...
$req="SELECT * FROM `etudiants` where code_entreprise='$codes'";
...
$req="SELECT * FROM `etudiants` where code_entreprise='dbfdhjf_jjkf67'";
$rs=mysql_query($req) or (die(mysql_error()));
		...
		<th bgcolor="#000000" style="color:#FFFFFF;" >ANNEE</th>
				...
				<?php while($ET1=mysql_fetch_assoc($rs)){?>
					...
					<tr>	<td onclick="actualiz()" style="color:#000000;" >&bull;</td>
							...
							<td><a href="cotes_par_etudiant.php?id=<?php echo($ET1['id'])?>">Coter</a></td>
